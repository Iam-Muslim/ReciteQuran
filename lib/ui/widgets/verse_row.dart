...
// - Listens to BOTH [WebHighlightingController] AND [AppState]
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...errors.map((e) {
                        String cleanPhoneticString(String input) {
                          return input
                              ...
                              .replaceAll(
                                'ڇ',
                                '',
                              ) // Qalqalah bounce phonetic marker
                        ...
                        final String expected = e.expectedPh.isEmpty
                            ? '(none)'
                            : cleanPhoneticString(e.expectedPh);
                        final String predicted = e.predictedPh.isEmpty
                            ? '(none)'
                            : cleanPhoneticString(e.predictedPh);
                        ...
                        if (e.errorType.toString().contains('tajweed')) {
                          ...
                          if (ruleName.isEmpty &&
                              e.expectedRule?.name.ar != null) {
                            ruleName = e.expectedRule!.name.ar;
                          }

                          if (e.expectedDuration != null &&
                              e.actualDuration != null) {
                            String expSec = e.expectedDuration!.toStringAsFixed(
                              1,
                            );
                            String actSec = e.actualDuration!.toStringAsFixed(
                              1,
                            );
                            explanation = isAr
                        ...
                        } else if (e.errorType.toString().contains(
                          'tashkeel',
                        )) {
                          title = isAr
                              ? 'خطأ في الحركات'
                        ...
                        bool hasQalqalahMarker =
                            e.expectedPh.contains('ڇ') ||
                            e.expectedPh.contains('\u0687');
                        ...
                        if (hasQalqalahMarker &&
                            !e.errorType.toString().contains('tajweed')) {
                          specialHint += isAr
