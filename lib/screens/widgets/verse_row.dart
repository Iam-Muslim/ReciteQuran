...
class VerseRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // The outer ListenableBuilder in TrackingScreen already rebuilds all
    // visible VerseRow widgets on every controller notification. No need
    // for an inner listener — that was causing each row to rebuild TWICE.
